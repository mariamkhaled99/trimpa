...
const PassengerInfoForm = ({setSeatSelectionEnabled,seatSelectionEnabled}) => {
  ...
  const handleEmergencyContactChange = (e) => {
    setEmergencyContactSame(e.target.checked);
    if (e.target.checked) {
      // Update emergency contact fields to match passenger 1
      setFormData((prevData) => ({
        ...prevData,
        emergencyFirstName: prevData.firstName,
        emergencyLastName: prevData.lastName,
        emergencyEmail: prevData.email,
        emergencyPhone: prevData.phone,
      }));
    }
  };
  ...
  return (
    <Flex direction="column" p={4} mr={80}>
      ...
      <Box mb={20}>
        ...
        <FormControl id="emergencyContactSame" mb={4}>
          <Checkbox
            isChecked={emergencyContactSame}
            onChange={handleEmergencyContactChange}
          >
            Same as Passenger 1
          </Checkbox>
        </FormControl>
        {!emergencyContactSame && (
          <>
            <Flex direction="row" wrap="wrap" gap={2}>
              <FormControl id="emergencyFirstName" mb={4} isRequired flex="1">
              ...
              <FormControl id="emergencyLastName" mb={4} isRequired flex="1">
            ...
            <Flex direction="row" wrap="wrap" gap={2}>
              <FormControl id="emergency-email" mb={4} isRequired flex="1">
                <FormLabel>Emergency contact email address*</FormLabel>
                <Input type="email" placeholder="Email address" />
              </FormControl>
              <FormControl id="emergency-phone" mb={4} isRequired flex="1">
      ...
      <Box mb={6}>
        ...
        <p>
          ...
          fees are waived for loyalty program members. See the full bag policy.
        </p>
        <FormControl id="checked-bags" mb={4}>
          <FormLabel>Passenger 1 Checked bags</FormLabel>
